...
public abstract class BaseServiceTest extends Assertions {
	...
	public static WebArchive createDeployment() throws IOException {
		...
		return ShrinkWrap.create(WebArchive.class, "socialalert-jee-test.war")
				...
				.addPackage("com/bravson/socialalert/file/media")
				.addPackage("com/bravson/socialalert/file/picture")
				.addPackage("com/bravson/socialalert/file/video")
				...
				.addAsLibraries(libs)
				.addAsManifestResource(new File("src/main/webapp/META-INF/jboss-logging.properties"), "jboss-logging.properties")
