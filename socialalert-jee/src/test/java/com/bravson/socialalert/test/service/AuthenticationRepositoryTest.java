...
public class AuthenticationRepositoryTest extends BaseServiceTest {
	...
	private static AuthenticationConfiguration config = AuthenticationConfiguration
			...
			.userInfoUrl("http://localhost:8080/auth/realms/SocialAlert-Dev/protocol/openid-connect/userinfo")
			.build();  
	...
	public void findExistingUserInfo() {
		...
		assertThat(result).isPresent().hasValue(new UserInfo("33935dd6-d3b9-4215-9afa-984f5f28ccfc", "test@test.com", "test@test.com"));
	}
